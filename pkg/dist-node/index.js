...
var scrollSnapApi = require('scroll-snap-api');
...
class ScrollSnapArrows {
  ...
  arrowOnClick(direction) {
    scrollSnapApi.scrollSnapToNext(this.element, direction);
  }

  updateArrows() {
    const positions = scrollSnapApi.getScrollSnapPositions(this.element);
...
exports.ScrollSnapArrows = ScrollSnapArrows;
